...
#[test]
fn scan_2_line() {
    let result = feed_scanner_file(
        "scanner_test_file2.txt",
        Some(String::from(
...
fn ignore_line_comments_with_output() {
    let result = feed_scanner_file(
        "scanner_test_file5.txt",
        Some(String::from("Sxeme is awesome ; hello world!")),
    );
    let expected: Vec<String> = vec![
        String::from("Sxeme"),
        String::from("is"),
...
fn ignore_block_comment_with_output() {
    let result = feed_scanner_file(
        "scanner_test_file7.txt",
        Some(String::from(
            "Sxeme is awesome #| hello world! \n this is a comment |#",
        )),
    );
    let expected: Vec<String> = vec![
        String::from("Sxeme"),
